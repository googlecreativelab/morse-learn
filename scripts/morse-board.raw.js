var MorseBoard = function() {
    function MorseBoard(options) {
        _classCallCheck(this, MorseBoard);
        this.timeout = null;
        this.morseDictionary = dictionary.morseToEnglish;
        this.config = this.mergeSettings(options);
        this.create()
    }
    _createClass(MorseBoard, [{
        key: "mergeSettings",
        ...
        value: function create() {
            ...
            this.dotButton.innerHTML = '<span style="display: block; width: 36px; height: 36px; background: #231F20; border-radius: 50%; pointer-events: none;"></span>';
            ...
            this.dashButton.innerHTML = '<span style="display: block; width: 55px; height: 23px; background: #231F20; pointer-events: none;"></span>';
            ...
            if (this.config.notification && this.config.notificationStyle === "overlay") {
        ...
        value: function onKeydown(e) {
            var code = e.keyCode;
            if (this.config.dotKeyMap.indexOf(code) > -1 && code !== 13 && code !== 32) {
                this.dotButton.click()
            } else if (this.config.dashKeyMap.indexOf(code) > -1 && code !== 13 && code !== 32) {
                this.dashButton.click()
            }
            if (code === 13 && !this.config.autoCommit) {
                if (this.output.value && this.output.value !== null) {
                    this.output.dispatchEvent(new CustomEvent("commit",{
                        detail: {
            ...
            this.timeout = setTimeout(function() {
                if (_this.output.value && _this.output.value !== null) {
                    ...
                    if (_this.config.autoCommit) {
                        ...
                        _this.output.dispatchEvent(new CustomEvent("commit",{
                            detail: eventDetail
                        }))
                    }
                }
        ...
        value: function commit(e) {
            ...
            if (this.config.notification) {
                if (letter && (typeof letter === "undefined" ? "undefined" : _typeof(letter)) !== undefined) {
        ...
        value: function showNotification(letter, wrong) {
            var _this2 = this;
            if (this.config.notificationStyle === "output") {
                this.outputStyleTimeout = setTimeout(function() {
                    _this2.output.style.color = wrong ? "rgba(255, 65, 54, 0.8)" : "#231F20";
                ...
                this.el.innerHTML = '<span style="display: inline-block; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); vertical-align: middle;">' + (wrong ? "&empty;" : letter) + "</span>";
                this.el.style.background = wrong ? "rgba(255, 65, 54, 0.8)" : "rgba(0, 0, 0, 0.7)";
