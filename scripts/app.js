...
class App {
  ...
  preload() {
    ...
    // Images
    // this.game.load.image('a', 'assets/images/svg/a.svg');
    // this.game.load.image('b', 'assets/images/svg/b.svg');
    // this.game.load.image('c', 'assets/images/svg/c.svg');
    // this.game.load.image('d', 'assets/images/svg/d.svg');
    // this.game.load.image('e', 'assets/images/svg/e.svg');
    // this.game.load.image('f', 'assets/images/svg/f.svg');
    // this.game.load.image('g', 'assets/images/svg/g.svg');
    // this.game.load.image('h', 'assets/images/svg/h.svg');
    // this.game.load.image('i', 'assets/images/svg/i.svg');
    // this.game.load.image('j', 'assets/images/svg/j.svg');
    // this.game.load.image('k', 'assets/images/svg/k.svg');
    // this.game.load.image('l', 'assets/images/svg/l.svg');
    // this.game.load.image('m', 'assets/images/svg/m.svg');
    // this.game.load.image('n', 'assets/images/svg/n.svg');
    // this.game.load.image('o', 'assets/images/svg/o.svg');
    // this.game.load.image('p', 'assets/images/svg/p.svg');
    // this.game.load.image('q', 'assets/images/svg/q.svg');
    // this.game.load.image('r', 'assets/images/svg/r.svg');
    // this.game.load.image('s', 'assets/images/svg/s.svg');
    // this.game.load.image('t', 'assets/images/svg/t.svg');
    // this.game.load.image('u', 'assets/images/svg/u.svg');
    // this.game.load.image('v', 'assets/images/svg/v.svg');
    // this.game.load.image('w', 'assets/images/svg/w.svg');
    // this.game.load.image('x', 'assets/images/svg/x.svg');
    // this.game.load.image('y', 'assets/images/svg/y.svg');
    // this.game.load.image('z', 'assets/images/svg/z.svg');

    this.game.load.image('a', 'assets/images/png/A.png');
